...
const dictionaries = {
  da: {
    ...
    home: {
      ...
      highlightIntro: "Udvalgte markeder med gode adresser, links og klare tidspunkter.",
    ...
    explorer: {
      ...
      intro: "Filtrér på dato, kategori og kvarter. Kort, liste og kalender bruger samme datasæt.",
      searchLabel: "Søg efter navn, adresse eller website",
  ...
  en: {
    ...
    home: {
      ...
      highlightIntro: "Featured markets with exact addresses, useful links, and clear times.",
    ...
    explorer: {
      ...
      intro: "Filter by date, category, and neighborhood. List, map, and calendar stay in sync.",
      searchLabel: "Search by name, address, or website",
