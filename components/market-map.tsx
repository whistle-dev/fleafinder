...
import { getWebsiteLabel } from "@/lib/utils";
  ...
  useEffect(() => {
    ...
    const renderPopup = (
      ...
      const addressLabel = market.venueName
        ...
        : market.addressLine;
      const websiteLabel = getWebsiteLabel(market.website) || market.city;
        ...
        <div style="background-color: transparent; padding: 0.5rem 0.25rem;">
          ...
          <div style="display: flex; flex-direction: column; gap: 0.25rem; font-size: 0.75rem; color: var(--ink-soft); margin-top: 0.25rem;">
            ...
            <div style="display: flex; align-items: center; gap: 0.35rem;">
               ...
               <span style="white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: var(--ink-soft);">${websiteLabel}</span>
            </div>
          </div>
        </div>
      `;
